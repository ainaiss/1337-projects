...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/07 17:33:43 by fel-boua          #+#    #+#             */
/*   Updated: 2021/12/15 01:38:48 by fel-boua         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_set_data(t_simulation *simulation, int num, int i)
{
	if (i == 1)
	{
		if (num == 0)
			return (ft_error_put(NULL,
					"Error: NO PHILOSOPHER IN THE TABLE", 1));
	...
	else if (i == 2)
	{
		...
		return (ft_set_rest(simulation, num, i));
	return (0);
}
